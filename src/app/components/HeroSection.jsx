...
export default function HeroSection() {
  ...
  const showMaterials = ['transitioning', 'showing', 'fading'].includes(phase);
  const hideTitle = ['transitioning', 'showing', 'fading'].includes(phase);
  const showInventory = phase === 'showing';
  const removeTitle = ['transitioning', 'showing', 'fading'].includes(phase);

  const handleFileProcessed = (materials) => {
  ...
  const handleInventoryFadeComplete = () => {
    if (phase === 'fading') {
      setPhase('resetting');
    }
  };
